package com.weaver.generator.utils;
...
import com.weaver.common.constants.DateFormatConstant;
import com.weaver.generator.model.ColumnEntity;
import com.weaver.generator.model.TableEntity;
...
public class GenUtils {
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        map.put("datetime", LocalDateTime.now()
                .format(DateTimeFormatter.ofPattern(DateFormatConstant.YYYY_MM_DD_HH_MM_SS)));
